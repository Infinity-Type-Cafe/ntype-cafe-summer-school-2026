...
∞-type Café 暑期学校 2026 将会在 2026 年 8 月 7 日正式开始。这次活动是第二届暑校（[第一届暑校](https://infinity-type-cafe.github.io/ntype-cafe-summer-school)）！
...
本次系列课程将于 2026 年 8 月 7 日开始，内容涵盖无穷范畴、AI4Math、HOL、tactic 编写与数学研究等主题。除特别标注外，具体上课时间及参与方式将在后续公布。

| 日期 | 时间 | 讲者 | 课程 |
| --- | --- | --- | --- |
| 8 月 7 日（周五） | 待定 | Cha0sButterf1y | 无穷范畴（一） |
| 8 月 8 日（周六） | 待定 | Cha0sButterf1y | 无穷范畴（二） |
| 8 月 9 日（周日） | 待定 | Cha0sButterf1y | 无穷范畴（三） |
| 8 月 12 日（周三） | 待定 | Gestellmensch | 0=1−1=−1+1=0 |
| 8 月 13 日（周四） | 待定 | 天行狸🐱 | SNL 与文档管理 |
| 8 月 15 日（周六） | 待定 | kokic | AI4M 的困境 |
| 8 月 16 日（周日） | 待定 | kokic | HOL 所选择的道路 |
| 8 月 19 日（周三） | 待定 | 子鱼 | AI4M 的出路 |
| 8 月 20 日（周四） | 待定 | 子鱼 | 如何写 tactic（一） |
| 8 月 22 日（周六） | 待定 | 子鱼 | 如何写 tactic（二） |
| 8 月 24 日（周一） | 下午（暂定） | 子鱼 | 如何写 tactic（三） |
| 8 月 29 日（周六） | 待定 | Gestellmensch | 还能做一辈子的数学研究吗? |
